...
<nav class="navbar navbar-expand-sm border shadow-sm" style="background-color: #e0efff">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <%=activeLink("Home", request)%>" href="<%=Server.ROOT%>?page=Home">
              <i class="fa-solid fa-house"></i>
              Home
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <%=activeLink("About", request)%>" href="<%=Server.ROOT%>?page=About">
        ...
        <% if(loggedIn != null) { %>
          ...
          <% if(user.type.compareTo("manager") == 0) { %>
        ...
        <ul class="navbar-nav">
          ...
          <% } else { %>
            <li>
              <a class="dropdown-item <%=activeLink("Login", request)%>" href="<%=Server.ROOT%>?page=Login">
